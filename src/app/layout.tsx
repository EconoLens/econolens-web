                ...
                <div className="ticker-track">
                  {doubled.map((item, i) => (
                      <span key={i} className="ticker-item">
                                  <span className="ticker-label">{item.label}</span>span>
                                  <span className="ticker-value">{item.value}</span>span>
                                  <span
            ...
            <nav className="nav-bar" role="navigation" aria-label="Main navigation">
                  <div className="nav-inner">
                          ...
                          <div className="nav-actions">
                                    <SignedOut>
                                                <a href="/sign-in" className="nav-signin">Sign in</a>a>
                                                <a href="/pricing" className="btn-subscribe">Subscribe ₹199</a>a>
                                    </SignedOut>SignedOut>
                                    <SignedIn>
                                                <a href="/dashboard" className="nav-signin">Dashboard</a>a>
                                                <a href="/pricing" className="btn-subscribe">Upgrade</a>a>
                                    </SignedIn>SignedIn>
                          </div>div>
                  </div>div>
            </nav>nav>
        ...
        const dateStr = now.toLocaleDateString('en-GB', {
            ...
            return (
                  <div className="dateline-bar">
                        <span className="dateline-text">{dateStr}</span>span>
                        <span className="dateline-edition">GLOBAL ECONOMICS INTELLIGENCE</span>span>
                  </div>div>
                )
}
          ...
          <footer className="footer">
                <div className="container">
                        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '40px' }}>
                                  <div>
                                              <div className="footer-logo">Econo<span>Lens</span>span></div>div>
                                  ...
                                  <div>
                                              <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.5625rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-tertiary)', marginBottom: '14px' }}>Platform</p>p>
                                              <a href="/articles" className="footer-link">News</a>a>
                                              <a href="/indicators" className="footer-link">Indicators</a>a>
                                              <a href="/study" className="footer-link">Study</a>a>
                                              <a href="/pricing" className="footer-link">Pricing</a>a>
                                  </div>div>
                                  <div>
                                              ...
                                              <a href="/about" className="footer-link">About</a>a>
                                              <a href="/about#contributors" className="footer-link">Contributors</a>a>
                                              <a href="mailto:khagankp@gmail.com" className="footer-link">Contact</a>a>
                                  </div>div>
                                  <div>
                                              <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.5625rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-tertiary)', marginBottom: '14px' }}>Legal</p>p>
                                              <a href="/privacy" className="footer-link">Privacy Policy</a>a>
                                              <a href="/terms" className="footer-link">Terms of Service</a>a>
                                              <a href="/disclaimer" className="footer-link">Disclaimer</a>a>
                                  </div>div>
                        </div>div>
                        <div className="footer-bottom">
                                  <span className="footer-legal">© 2026 ECONOLENS MEDIA AND TECHNOLOGY. ALL RIGHTS RESERVED.</span>span>
                                  <span className="footer-legal">SOURCES: RBI · IMF · WORLD BANK · NBER · ECB</span>span>
                        </div>div>
                </div>div>
          </footer>footer>
        )
