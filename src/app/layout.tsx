...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered economics news, research, and analysis with India context. 30 articles daily from RBI, IMF, World Bank, and top research institutions.',
...
/* ── Ticker items — static; replace with real API data when Make.com is live ── */
const TICKER_ITEMS = [
  ...
  { label: 'CPI INDIA', value: '4.1%', change: '▼0.3', pos: true },
  { label: 'INDIA GDP', value: '6.4%', change: '▲0.2', pos: true },
...
function DatelineBar() {
  ...
  return (
    <div className="dateline-bar">
      <span className="dateline-text">{dateStr} · INDIA ECONOMICS INTELLIGENCE</span>
      <span className="dateline-edition">INDIA EDITION · AI-POWERED · 30 ARTICLES DAILY</span>
    </div>
  )
}
    ...
    <footer className="footer">
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '40px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.8125rem', color: 'var(--text-tertiary)', marginTop: '10px', lineHeight: '1.6', maxWidth: '260px' }}>
              India&apos;s AI-powered economics intelligence platform. 30 articles daily. Three layers of depth.
            </p>
          ...
          <div>
            ...
            <a href="/research" className="footer-link">AI Research</a>
        ...
        <div className="footer-bottom">
          ...
          <span className="footer-legal">AI-ASSISTED CONTENT · SOURCES: RBI · IMF · WORLD BANK · NBER · ECB</span>
        </div>
      </div>
    </footer>
  )
